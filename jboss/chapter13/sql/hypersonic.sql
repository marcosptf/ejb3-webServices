...
insert into items (ITEM_ID, ITEM_NAME, INITIAL_PRICE, BID_START_DATE, BID_END_DATE, CREATED_DATE, SELLER_ID, OPTIMISTIC_LOCK)
values (1, 'Vintage Car', 100.50, now(), now(), now(), 'junkseller', 1);

insert into items (ITEM_ID, ITEM_NAME, INITIAL_PRICE, BID_START_DATE, BID_END_DATE, CREATED_DATE, SELLER_ID, OPTIMISTIC_LOCK)
values (2, 'Cars junked', 200.50, now(), now(), now(), 'junkseller', 1);

insert into items (ITEM_ID, ITEM_NAME, INITIAL_PRICE, BID_START_DATE, BID_END_DATE, CREATED_DATE, SELLER_ID, OPTIMISTIC_LOCK)
values (3, 'Bell Bottom Pants', 120.50, now(), now(), now(), 'junkseller', 1)
